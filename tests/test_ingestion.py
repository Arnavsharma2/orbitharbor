...
class TestNormalizeVessel:
    ...
    def test_equator_and_prime_meridian_are_valid(self, raw_ais_position_report):
        """Zero coordinates are valid and must not be treated as missing."""
        raw_ais_position_report["MetaData"]["latitude"] = 0.0
        raw_ais_position_report["MetaData"]["longitude"] = 0.0
    ...
    def test_out_of_range_coordinates_return_none(self, raw_ais_position_report):
        """Positions outside WGS84 bounds are filtered out."""
        raw_ais_position_report["MetaData"]["latitude"] = 91.0

        assert normalize_vessel(raw_ais_position_report) is None
...
class TestNormalizeAircraft:
    ...
    def test_non_finite_coordinates_return_none(self, raw_aircraft):
        """NaN and infinite coordinates are filtered out."""
        raw_aircraft["longitude"] = float("nan")

        assert normalize_aircraft(raw_aircraft) is None
